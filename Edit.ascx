<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Christoc.Modules.Calvary_VideoCourse.Edit" %>
...
<div class="dnnForm dnnEditBasicSettings" id="dnnEditBasicSettings">
    ...
    <fieldset>
        <div class="dnnFormItem">
			<dnn:label id="lblVimeoId" runat="server" />
            <asp:TextBox ID="txtVimeoId" runat="server" />
        </div>
        <div class="dnnFormItem">

            <dnn:label ID="lblCourseId" runat="server" />
            <asp:TextBox ID="txtCourseId" runat="server" TextMode="MultiLine" Rows="5" Columns="20" />
        </div>
        <div class="dnnFormItem">

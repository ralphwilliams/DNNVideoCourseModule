Module instructions http://ralphwilliams.github.io/DNNVideoCourseModule/ 
...
# Known Issues
This module currently suports DNN 8 only. DNN 9 has known issues with managing users from within the module.

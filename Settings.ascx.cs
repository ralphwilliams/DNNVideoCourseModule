...
namespace Christoc.Modules.Calvary_VideoCourse
{
	...
	/// 
	/// Because the control inherits from Calvary_VideoCourseSettingsBase you have access to any custom properties
	/// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
	/// </summary>
	/// -----------------------------------------------------------------------------
	public partial class Settings : Calvary_VideoCourseModuleSettingsBase
	{
